...
# sq3_39_0 = [normal['39'][0], inner1['39'][0], outer1['39'][0]]
# sq3_39_1 = [normal['39'][1], inner1['39'][1], outer1['39'][1]]
...
# -----------------------------test_dir-----------------------------------
# 1'
test3_dir109 = [normal['09'][1], inner1['09'][1], outer1['09'][1]]
test3_dir119 = [normal['19'][1], inner1['19'][1], outer1['19'][1]]
test3_dir129 = [normal['29'][1], inner1['29'][1], outer1['29'][1]]
test3_dir139 = [normal['39'][1], inner1['39'][1], outer1['39'][1]]
# 2'
test3_dir209 = [normal['09'][1], inner2['09'][1], outer2['09'][1]]
test3_dir219 = [normal['19'][1], inner2['19'][1], outer2['19'][1]]
test3_dir229 = [normal['29'][1], inner2['29'][1], outer2['29'][1]]
test3_dir239 = [normal['39'][1], inner2['39'][1], outer2['39'][1]]
# 3'
test3_dir309 = [normal['09'][1], inner3['09'][1], outer3['09'][1]]
test3_dir319 = [normal['19'][1], inner3['19'][1], outer3['19'][1]]
test3_dir329 = [normal['29'][1], inner3['29'][1], outer3['29'][1]]
test3_dir339 = [normal['39'][1], inner3['39'][1], outer3['39'][1]]

test3_dir09 = [outer1['09'][1], outer2['09'][1], outer3['09'][1]]
test3_dir19 = [outer1['19'][1], outer2['19'][1], outer3['19'][1]]
test3_dir29 = [outer1['29'][1], outer2['29'][1], outer3['29'][1]]
test3_dir39 = [outer1['39'][1], outer2['39'][1], outer3['39'][1]]

# ------------------------ multiple classes ------------------------------
train5_dir39 = [normal['39'][0], inner1['39'][0], inner2['39'][0], outer1['39'][0], outer2['39'][0]]
train5_dir19 = [normal['19'][0], inner1['19'][0], inner2['19'][0], outer1['19'][0], outer2['19'][0]]

test4_dir39 = [inner1['39'][1], inner2['39'][1], outer1['39'][1], outer2['39'][1]]
test4_dir29 = [inner1['29'][1], inner2['29'][1], outer1['29'][1], outer2['29'][1]]
test4_dir19 = [inner1['19'][1], inner2['19'][1], outer1['19'][1], outer2['19'][1]]
test4_dir09 = [inner1['09'][1], inner2['09'][1], outer1['09'][1], outer2['09'][1]]

test5_dir39 = [normal['39'][1], inner2['39'][1], inner3['39'][1], outer2['39'][1], outer3['39'][1]]
test5_dir29 = [normal['29'][1], inner2['29'][1], inner3['29'][1], outer2['29'][1], outer3['29'][1]]
test5_dir19 = [normal['19'][1], inner2['19'][1], inner3['19'][1], outer2['19'][1], outer3['19'][1]]
test5_dir09 = [normal['09'][1], inner2['09'][1], inner3['09'][1], outer2['09'][1], outer3['09'][1]]

test6_dir39 = [inner1['39'][1], inner2['39'][1], inner3['39'][1], outer1['39'][1], outer2['39'][1],
               outer3['39'][1]]
test6_dir29 = [inner1['29'][1], inner2['29'][1], inner3['29'][1], outer1['29'][1], outer2['29'][1],
               outer3['29'][1]]
test6_dir19 = [inner1['19'][1], inner2['19'][1], inner3['19'][1], outer1['19'][1], outer2['19'][1],
               outer3['19'][1]]
test6_dir09 = [inner1['09'][1], inner2['09'][1], inner3['09'][1], outer1['09'][1], outer2['09'][1],
               outer3['09'][1]]

test7_dir39 = [normal['39'][1], inner1['39'][1], inner2['39'][1], inner3['39'][1], outer1['39'][1],
               outer2['39'][1], outer3['39'][1]]
test7_dir29 = [normal['29'][1], inner1['29'][1], inner2['29'][1], inner3['29'][1], outer1['29'][1],
               outer2['29'][1], outer3['29'][1]]
test7_dir19 = [normal['19'][1], inner1['19'][1], inner2['19'][1], inner3['19'][1], outer1['19'][1],
               outer2['19'][1], outer3['19'][1]]
test7_dir09 = [normal['09'][1], inner1['09'][1], inner2['09'][1], inner3['09'][1], outer1['09'][1],
               outer2['09'][1], outer3['09'][1]]
